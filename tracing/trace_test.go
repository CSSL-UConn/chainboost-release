...
func TestNewStackEntry(t *testing.T) {
	for i, test := range []struct {
		...
		}, {"github.com/basedfs/honeycomb.TestNewTrace(0xc0001b2200)",
			"/home/foo/onet/honeycomb/trace_test.go:19",
			stackEntry{
				line: 19, path: "/home/foo/onet" +
					"/honeycomb/", file: "trace_test.go",
				pkgPath: "github.com/basedfs/honeycomb", method: "TestNewTrace",
				params: "(0xc0001b2200)",
			}, false,
		}, {"testing.tRunner",
		...
		{
			"github.com/basedfs/honeycomb.(*oneStr).more.(*another).one(" +
			...
			stackEntry{32, "/home/foo/onet/honeycomb/", "stack_test.go",
				"github.com/basedfs/honeycomb.(*oneStr).more.(*another)",
	...
	}{
		{
			...
			[]stackEntry{
				{line: 105, path: "/home/foo//onet/log/",
					file:    "testutil.go",
					pkgPath: "github.com/basedfs/log", method: "Stack", params: "(...)"},
...
github.com/basedfs/tracing.tg()
/home/foo//onet/tracing/logger_test.go:116 +0x44
created by github.com/basedfs/tracing.TestGor
...
github.com/basedfs/log.Stack(...)
	/home/foo//onet/log/testutil.go:105
github.com/basedfs/tracing.subgo(0xc000388410)
	/home/foo//onet/tracing/logger_test.go:85 +0x87
created by github.com/basedfs/tracing.goroutines
...
github.com/basedfs/log.Stack(...)
	/home/foo//onet/log/testutil.go:105
github.com/basedfs/tracing.goroutines(0x0)
	/home/foo//onet/tracing/logger_test.go:74 +0xc7
github.com/basedfs/tracing.TestGoroutines.func1(0xc0001e8620, 0x0)
	/home/foo//onet/tracing/logger_test.go:56 +0x39
created by github.com/basedfs/tracing.TestGoroutines
...
func TestTraceID(t *testing.T) {
	...
	tr.AddEntryPoints("github.com/basedfs/tracing.setTraceID")
